...
$sender = 	"491624314882"; // Mobile number with country code (but without + or 00)
$imei = 	"359090045566005/07"; // MAC Address for iOS IMEI for other platform (Android/etc)
$password =     "70/500665540090953"; // Password you received from WhatsApp
